        ...
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                {asChild ?
                    ...
                    >
                        <Share2 className="size-4 sm:size-5 min-w-4 sm:min-w-5 text-foreground" />
                    </Button>
                }
            </DropdownMenuTrigger>
            <DropdownMenuContent className="bg-background/95 backdrop-blur-md border-white/20">
                <DropdownMenuItem 
                    onClick={copyLink} 
                    className='flex items-center gap-2 text-sm cursor-pointer hover:bg-white/10 focus:bg-white/10'
                >
                    <Copy className='size-4 min-w-4 text-foreground' />
                ...
                <DropdownMenuItem className='hover:bg-white/10 focus:bg-white/10'>
                    <WhatsappShareButton url={url} className='flex items-center gap-2 text-sm w-full'>
                ...
                <DropdownMenuItem className='hover:bg-white/10 focus:bg-white/10'>
                    <FacebookShareButton url={url} className='flex items-center gap-2 text-sm w-full'>
                ...
                <DropdownMenuItem className='hover:bg-white/10 focus:bg-white/10'>
                    <TwitterShareButton url={url} className='flex items-center gap-2 text-sm w-full'>
                        <X className='size-4 min-w-4 text-foreground' />
                        <span className='text-xs text-foreground'>X (Twitter)</span>
                    </TwitterShareButton>
                </DropdownMenuItem>
                <DropdownMenuItem className='hover:bg-white/10 focus:bg-white/10'>
                    <LinkedinShareButton url={url} className='flex items-center gap-2 text-sm w-full'>
