...
const Flipbook = memo(({ viewerStates, setViewerStates, flipbookRef, pdfDetails, isMobileOrTablet }) => {
    ...
    return (
        <div ref={ref} className={cn("relative h-[calc(100vh-135px)] w-full bg-transparent flex justify-center items-center overflow-hidden", screenfull?.isFullscreen && 'h-[calc(100vh-5.163rem)] xs:h-[calc(100vh-5.163rem)] lg:h-[calc(100vh-5.163rem)] xl:h-[calc(100vh-4.66rem)]')}>
